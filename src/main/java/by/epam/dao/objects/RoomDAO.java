...
public class RoomDAO extends AbstractDAO<Integer,Room> {
    private static final String SQL_SELECT_ALL_ROOMS = DataBaseConfigurationManager.get("room.selectAll");
    private static ConnectionPool pool;
    private static final String SQL_SELECT_ROOMS_BY_ID = DataBaseConfigurationManager.get("room.selectById");
    private static final String SQL_DELETE_ROOMS_BY_ID = DataBaseConfigurationManager.get("room.deleteById");
    private static final String SQL_INSERT_ROOMS = DataBaseConfigurationManager.get("room.insert");
    private static final String SQL_UPDATE_ROOMS = DataBaseConfigurationManager.get("room.update");
    static{
    ...
    public List<Room> findAll() throws SQLException {
        ...
        logger.info(String.format("%d rooms were selected", rooms.size()));
        return rooms;
    }
    ...
    public Room findEntityById(Integer id) throws SQLException {
        ...
        logger.info(String.format("Room with id %d was selected", id));
        return room;
    }
    ...
    public boolean delete(Integer id) throws SQLException {
        ...
        logger.info(String.format("Room with id %d was deleted", id));
        return success;
    }
    ...
    public boolean delete(Room entity) throws SQLException {
        ...
        logger.info(String.format("Room with id %d was deleted", entity.getId()));
        return success;
    }
    ...
    public boolean create(Room entity) throws SQLException {
        ...
        logger.info(String.format("Room with id %d was added", entity.getId()));
        return success;
    }
    ...
    public boolean update(Room entity) throws SQLException {
        ...
        logger.info(String.format("Room with id %d was changed", entity.getId()));
        return success;
    }
}
